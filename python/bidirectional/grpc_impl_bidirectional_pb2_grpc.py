...
import grpc_impl_bidirectional_pb2 as grpc__impl__bidirectional__pb2
...
class BidirectionalStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.stream_stream(
                ...
                request_serializer=grpc__impl__bidirectional__pb2.Message.SerializeToString,
                response_deserializer=grpc__impl__bidirectional__pb2.Message.FromString,
                )
...
def add_BidirectionalServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=grpc__impl__bidirectional__pb2.Message.FromString,
                    response_serializer=grpc__impl__bidirectional__pb2.Message.SerializeToString,
            ),
    }
...
class Bidirectional(object):
    ...
    def GetServerResponse(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/bidirectional.Bidirectional/GetServerResponse',
            grpc__impl__bidirectional__pb2.Message.SerializeToString,
            grpc__impl__bidirectional__pb2.Message.FromString,
